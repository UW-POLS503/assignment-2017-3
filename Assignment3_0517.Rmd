...
rain$instrument<-rain$residuals+rain$LaggedGDPGrowth

reg_1_3<- lm(InternalConflict~ instrument + InitialGDP + Democracy + Mountains+ EthnicFrac+ ReligiousFrac +factor (country_name), data = rain)
summary(reg_1_3)
```
